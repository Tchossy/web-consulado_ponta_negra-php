  ...
  <header class="pageMainHead d-flex position-relative bgCover w-100 text-white"
    ...
    <div class="alignHolder d-flex w-100 align-items-center">
      <div class="align w-100 position-relative">
        <div class="container">
          <h1 class="text-white mb-2">Sector Notarial</h1>
        ...
        <div class="col-12 col-lg-8 col-xl-9 mb-6">
          <div class="pr-xl-14">
            <header class="fzMedium mb-6">
              <h2 class="fwSemiBold h2vii">Sector Notarial</h2>
            </header>
            <p>
              O sector notarial é uma área do direito que se dedica à
              prática de actos e procedimentos relacionados a documentos
              legais. Os serviços notariais desempenham um papel
              importante na garantia da segurança jurídica e na protecção
            ...
            <ul class="list-unstyled text-lDark">
              <li class="mb-4">
                1. <strong>Verifique os requisitos:</strong> Antes de
                solicitar qualquer serviço notarial, verifique se você
                possui todos os documentos necessários e se cumpre os
                requisitos exigidos pelo Consulado.
              </li>
              <li class="mb-4">
                2. <strong>Agende um horário:</strong> Para solicitar os
                serviços notariais, é necessário agendar um horário com
                antecedência. Entre aqui no website e terá acesso a página
                de agendamento.
              </li>
              <li class="mb-4">
                3. <strong>Envie os documentos:</strong> Leve os
                documentos necessários ao Consulado no dia do seu
                atendimento, para que o Sector Notarial possa verificar a
                documentação e preparar o serviço solicitado.
              </li>
              <li class="mb-4">
                4. <strong>Compareça ao atendimento:</strong> No dia e
                horário agendado, compareça ao atendimento no Consulado 5
                minutos antes da hora agendada. Lembre-se de levar todos
                os documentos originais necessários e o comprovante de
                pagamento, se aplicável.
              </li>
              <li class="mb-4">
                5. <strong>Retire o serviço solicitado:</strong> Após o
                processamento dos documentos e cumprimento das
                formalidades legais, você poderá recepcionar o seu visto
                ou documento no Consulado dentro do prazo estipulado.
              </li>
            </ul>

            <h3 class="fwSemiBold mb-4">Serviços do Sector Notarial</h3>
            <p>
              O sector notarial é responsável por uma série de serviços
              essenciais relacionados a documentos legais. Os serviços
              notariais oferecidos pelo Consulado proporcionam a segurança
              jurídica necessária para o cumprimento das formalidades
              legais. Com ampla experiência e profissionalismo, a equipa
              do Sector Notarial está sempre pronta para oferecer um
              atendimento de excelência e garantir a satisfação dos seus
              utentes.
            </p>
                      ...
                      <div class="modal-body">
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item">
                            <strong></strong> Lamentamos mas essa
                            informação está indisponível no momento...
                          </li>
                        </ul>
              ...
              <div class="order">
                <table>
                  ...
                  <tbody>
                    <tr>
                      <td>1</td>
                      <td>Assento de nascimento dos 0 aos 14 anos</td>
                      <td>Isento</td>
                    </tr>
                    <tr>
                      <td>2</td>
                      <td>Transcrição de nascimento dos 0 aos 14 anos</td>
                      <td>Isento</td>
                    </tr>
                    <tr>
                      <td>3</td>
