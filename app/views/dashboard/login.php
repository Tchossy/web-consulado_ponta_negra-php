...
if ((isset($_SESSION['adm_email']))) {
  header('Location: http://localhost/web-consulado_ponta_negra-php/dashboard/home');
}
        ...
        <div class="col-md-9 col-lg-7 col-xl-5 mx-auto">
          <div class="bg-white shadow-md rounded p-4 px-sm-5 mt-4">
            <div class="logo">
              ...
              <p class="text-center" style="font-size: 0.9rem;">Consulado Geral de Angola Ponta Negra</p>
            </div>

            <p class="text-center" style="font-size: 0.98rem;">Sistema Integrado para Gerenciamento da Pagina do
              Consulado</p>
